...
import { LISTINGS_TABLE_GRID_CLASS } from "../../lib/constants/table";
...
export const TableRow: React.FC<TableRowProps> = ({ listing, onNotify, isSelected = false, onSelect }) => {
  ...
  return (
    <div className={`grid ${LISTINGS_TABLE_GRID_CLASS} items-center border-t px-4 py-3 text-sm hover:bg-slate-50 transition-colors`}>

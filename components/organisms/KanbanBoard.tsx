        ...
        <div className="flex gap-2 h-full w-full">
          {stages.map((stage) => {
            ...
            return (
              ...
              >
                {/* Column Header */}
                <div className={`px-4 py-2 border-b-2 ${stage.borderColor} ${stage.bgColor} dark:border-coal-700`}>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      ></div>
                      <h3 className="font-semibold text-claude-ink dark:text-coal-100 truncate">{stage.name}</h3>
                    </div>
                  ...
                  {stats.value !== undefined && formatCurrency && (
                    <div className="text-xs text-claude-muted dark:text-coal-300 font-medium">
                ...
                <div className="flex-1 p-1 space-y-1 overflow-y-auto min-h-0 kanban-scrollbar">
                  {stageItems.length === 0 ? (
                    <div className={`text-center py-8 text-claude-subtle dark:text-coal-500 text-sm ${isDragOver ? 'border-2 border-dashed border-blue-400 dark:border-blue-500 rounded-lg' : ''}`}>
                    ...
                    stageItems.map((item) => (
                      <div
                        ...
                        className={`bg-claude-surface dark:bg-coal-850 rounded-lg border border-claude-border dark:border-coal-700 p-2 shadow-sm hover:shadow-md transition-all cursor-move ${
                ...
                {onCreateItem && (
                  <div 
                    className={`border-t-2 border-claude-border dark:border-coal-700 transition-all duration-300 ease-in-out overflow-hidden ${

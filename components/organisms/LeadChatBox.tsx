...
export interface LeadChatBoxProps {
...
export const LeadChatBox: React.FC<LeadChatBoxProps> = ({
  contactId,
  contactName,
  phone,
  onSent,
  ...
  return (
    <div className={`flex flex-col bg-white dark:bg-gray-900 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden min-h-0 ${className}`}>
      {/* Chat Header - same style as ContactChatInterface */}
      ...
      {/* Messages Area - same bubble styling as ContactChatInterface */}
      ...
      {/* Message Input - same as ContactChatInterface */}

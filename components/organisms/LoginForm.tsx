    ...
    <div className="min-h-screen bg-[url('/assets/images/background.png')] bg-cover bg-center dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="flex flex-col items-center justify-center text-center mb-8">
          ...
          <h1 className="text-3xl font-heading font-bold text-brand-primary dark:text-coal-100 mb-2">Welcome Back</h1>
          <p className="text-brand-primary font-heading dark:text-coal-400">Sign in to your Auto Buyer account</p>
        </div>

        {/* Login Form */}
        <div className="bg-primary-light dark:bg-coal-850 rounded-2xl shadow-xl p-8">
          <div className="flex items-center space-x-2 mb-6">
            <LogIn className="w-5 h-5 text-brand-primary dark:text-green-400" />
            <h2 className="text-xl font-heading font-semibold text-brand-primary dark:text-coal-100">Sign In</h2>
          </div>
          ...
          {/* Features */}
          <div className="mt-6 pt-6 border-t font-heading border-claude-border dark:border-coal-700">
            <div className="grid grid-cols-1 gap-3">
              <div className="flex items-center space-x-3 text-sm text-brand-primary dark:text-coal-400">
                <DefenceIcon />

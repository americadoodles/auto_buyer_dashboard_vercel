...
// This includes: score(1), source(1), vin(1), lpn(1), price(1), year(1), make(1), model(1), miles(1), notify(1), slack(1), workflow(1), updated_at(1) = 13 total
export const LISTINGS_TABLE_GRID_COLS = 13;

// CSS class name for the grid (must match Tailwind config)
// Note: We use static class name 'grid-cols-13' instead of template literal
...
export const LISTINGS_TABLE_GRID_CLASS = 'grid-cols-13';
